...
class AnalogClock(tk.Tk):
    def __init__(self):
        ...
        self.mode_24h = tk.BooleanVar(value=True)
    ...
    def update_clock(self):
         ...
         hours = current_time.tm_hour if self.mode_24h.get() else current_time.tm_hour % 12
